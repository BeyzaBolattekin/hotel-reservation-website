                                    ...
                                    <?php foreach ($data as $key => $record) { ?>
                                        <tr>
                                            ...
                                            <td class="action_column">
                                                <a href="cancel_booking.php?id=<?php echo $record['room_id']; ?>" class="view">Edit</a>

                                                <a href="cancel_booking.php?id=<?php echo $record['room_id']; ?>" class="delete" onclick="return confirm('Are you sure to delete this user!');">delete</a>
                                            </td>
                                        </tr>
                                    <?php }; ?>
                                <?php } else { ?>
